...
Взаимодействует с чат-бот сервиса тегелрам по [апи телеграм](https://core.telegram.org) и отправляет уведомления пользователю на ежедневной основе путём добавления id чата в список расписания или по запросу пользователя.
Можно:
- Подписаться на уведомления
- Отписаться от уведомления
- Запросить списко событий без подписки

## Технологии
Код проекта написан на python3 с применением микро фреймворка Flask.
Так же использованы апи сервисов KudaGo и API Telegram

## Установка
Для установки проекта на ПК, исходный код необходимо скачать
- На главной странице проекта https://github.com/belousovsergey56/EventNotify
- Нажать на зелёную кнопку `code`
- В сплывающем окне выбрать `Download ZIP`
